                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="sliderTitle" name="sliderTitle"
                                                          placeholder="Title">
                                                </textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="choseEditImage">
                                                    <label for="uploadImage" class="editImageUp btn">Chose a
                                                        image </label>
                                                    <input type="file" class="form-control" id="uploadImage" name="sliderImage" hidden>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form action="{{ route('slider.update','1')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label for="editSliderTitle">Slider Title <span
                                                        class="req">*</span>
                                                </label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="componentDescription">Slider Description <span
                                                        class="req">*</span>
                                                </label>
...
@push('onpage-js')
    <script>
        ...
        $(document).on('click', '.edit_row', function (e) {
            ...
            $.ajax({
                type: "get",
                url: "{{ url('admin/slider') }}/" + row_id + "/edit",
                dataType: "json",
