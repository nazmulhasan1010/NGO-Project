        ...
        <div class="container-fluid">
            ...
            <div class="row">
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    ...
                                                    <form id="delete-form-{{$item->id}}"
                                                          action="{{ route('about.destroy',$item->id.".Project Goal") }}"
                            ...
                            <form action="{{ route('about.store')}}" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="">
                                        ...
                                        <label for="overview">Project goal <span class="req">*</span> </label>
                ...
                <div class="modal fade" id="editModal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="{{ route('about.update','project_goal.Project Goal')}}" method="POST">
                                @csrf
                                @method("PUT")
                                <div class="modal-header">
                                    <h5 class="modal-title">Edit Project goal</h5>
                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
